	...
	<tr>
		...
		<td colspan="2"><b><bean:message key="oscar.billing.CA.ON.billingON.OB.SLIcode"/>: </b>
			<select name="xml_slicode">
				...
				<option value="PDF " <%=sliCode.startsWith("OTN")?"selected":""%>><bean:message key="oscar.billing.CA.ON.billingON.OB.SLIcode.PDF" /></option>
...
function display3rdPartyPayments() {
    popupPage('500', '500', 'billingON3rdPayments.do?method=listPayments&billingNo=<%= billNo %>');
}
</script>
