...
<%//
	...
	%>
			...
			<p>
				<center><h1>Successful Addition of a billing Record.</h1></center>
		  ...
		  <% } %>
	<% /*update appt and close end*/} else { %>
		<p>
		<center><h1>Sorry, billing has failed. Please do it again!</h1></center>
	<%}
  }/* save billing end*/ else { %> 
	<p>
	<center><h1>Sorry, billing has failed. Please do it again!</h1></center>
<%} %>
