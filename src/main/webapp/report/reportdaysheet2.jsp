...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
	<tr align="center">
		<td><font size=6><%=clinicData.getClinicName() %></font></td>
	</tr>
	<tr align="center">
