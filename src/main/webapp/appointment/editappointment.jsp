...
<% } %>
        ...
        <li class="weak row">
           ...
           <% String lastUpdateUserNo = bFirstDisp?((String)appt.get("lastupdateuser")):request.getParameter("user_id");
				String lastUpdateUser = "";
				if(lastUpdateUserNo!=null)
					lastUpdateUser = providerDao.getProviderName(lastUpdateUserNo);				
			%>

            <INPUT TYPE="TEXT" NAME="user_id" VALUE="<%=lastUpdateUser%>" readonly WIDTH="25">
...
>>>>>>> 049d0185e85ef5695afe24f4aaf7e25c1482c08f
			</tr>
		<%}%>
		<%}%>
		<%}%>
