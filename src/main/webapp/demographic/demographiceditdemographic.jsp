...
function referralScriptAttach2(elementName, name2) {
	...
	re_no = document.forms[1].elements['r_doctor_ohip'].value;
	re_na = document.forms[1].elements['r_doctor'].value;
	rs('att',('../billing/CA/ON/searchRefDoc.jsp?param='+t0+'&param2='+t1+'&re_no='+re_no+'&re_na='+re_na),600,600,1);
}
						...
						<ul>
							...
							<bean:message
								key="demographic.demographiceditdemographic.formDoctor" />
                                                    ...
                                                    <li><span class="label">
													<%if(OscarProperties.getInstance().getBooleanProperty("ALTERNATE_PROVIDER_TYPE_IN_DEMOGRAPHIC", "true")) {%>
														<%=OscarProperties.getInstance().getProperty("ALTERNATE_RESIDENT_LABEL","") %>
													<%} else { %>
														<bean:message key="demographic.demographiceditdemographic.formResident" />
													<% } %>:</span>
													<span class="info"><%=providerBean.getProperty(resident,"")%></span>
													</li>
													
                                                    <li><span class="label">
													<%if(OscarProperties.getInstance().getBooleanProperty("ALTERNATE_PROVIDER_TYPE_IN_DEMOGRAPHIC", "true")) {%>
														<%=OscarProperties.getInstance().getProperty("ALTERNATE_MIDWIFE_LABEL","") %>
													<%} else { %><bean:message key="demographic.demographiceditdemographic.formMidwife" />
                                                    <%} %>:</span><span class="info"><%=providerBean.getProperty(midwife,"")%></span>
													</li>
													
                                                    <li><span class="label">
                                                    <%if(OscarProperties.getInstance().getBooleanProperty("ALTERNATE_PROVIDER_TYPE_IN_DEMOGRAPHIC", "true")) {%>
														<%=OscarProperties.getInstance().getProperty("ALTERNATE_NURSE_LABEL","") %>
													<%} else { %><bean:message
...
<%} %>
                        ...
                        %>
								...
								<%if(OscarProperties.getInstance().getBooleanProperty("ALTERNATE_PROVIDER_TYPE_IN_DEMOGRAPHIC", "true")) {%>
										<%=OscarProperties.getInstance().getProperty("ALTERNATE_RESIDENT_LABEL","") %>
								<%} else { %><bean:message key="demographic.demographiceditdemographic.formResident" />
								<%} %>: </b></td>
                        ...
                        %>
								...
								<%if(OscarProperties.getInstance().getBooleanProperty("ALTERNATE_PROVIDER_TYPE_IN_DEMOGRAPHIC", "true")) {%>
										<%=OscarProperties.getInstance().getProperty("ALTERNATE_NURSE_LABEL","") %>
								<%} else { %><bean:message 	key="demographic.demographiceditdemographic.formNurse" />
								<%} %>:</b></td>
