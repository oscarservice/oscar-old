...
<ul bgcolor="#C0C0C0">
	...
	<%
	String currentUserId = session.getAttribute("user").toString();
	SuperSiteUtil superSiteUtil = SuperSiteUtil.getInstance(currentUserId);
	%>
	<%@ include file="../demographic/zzdemographicsearchresult.jspf"%>
	<%
	String demoId_ = apptMainBean.getString(rs,"demographic_no");
	if(!superSiteUtil.isUserAllowedToOpenPatientDtl(demoId_))
		continue;
...
%> 
	...
	<security:oscarSec objectName="_create_new_demographic" roleName="<%=roleName$%>" rights="r" reverse="false">
    <div class="createNew">
