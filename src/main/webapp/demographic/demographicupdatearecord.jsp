    ...
    demographicDao.save(demographic);
	  ...
	  //multiple site, update site
	   if (org.oscarehr.common.IsPropertiesOn.isMultisitesEnable()) { 
		   ...
		   if(sites!=null) {/*
			   List<DemographicSite> demoSites = demographicSiteDao.findSitesByDemographicId(Integer.valueOf(demoNo));
			   for(DemographicSite demoSite : demoSites) {			   
				   demographicSiteDao.remove(demoSite);
			   }*/
