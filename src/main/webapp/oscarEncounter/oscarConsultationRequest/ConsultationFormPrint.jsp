...
<%
	if (request.getParameter("reqId")!=null) request.setAttribute("reqId", request.getParameter("reqId"));
    ...
    if (bMultisites) {
        ...
        vecAddressBillingNo = new Vector();
    		...
    		SiteDao siteDao = (SiteDao)WebApplicationContextUtils.getWebApplicationContext(application).getBean("siteDao");
 			...
 			//Site defaultSite = (sites!=null && sites.size()>0)?sites.get(0):null;
 			Site defaultSite = null;
 			
 			//if request came from scheduler to export consultations.. then this might be null 
