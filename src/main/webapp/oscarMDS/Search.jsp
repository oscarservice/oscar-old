				...
				<td><select name="searchProviderNo" size="10">
					...
					<OPTGROUP LABEL="Docs with labs">
						...
						<option
							...
							<%= ( ((String) ((ArrayList) providers2.get(i)).get(0)).equals(request.getParameter("providerNo")) ? " selected" : "" ) %>><%= (String) ((ArrayList) providers2.get(i)).get(2) %>, 
						<%= (String) ((ArrayList) providers2.get(i)).get(1) %></option>
						<% } %>
					</optgroup>
