...
--%>
<%@page import="com.oscar.eformportal.ws.service.GetNewEformCount"%>
<%@page import="com.oscar.eformportal.ws.service.SetTime"%>
...
<script language="javascript">
  ...
  function openPortal(obj){
	  ...
	  window.location='efmformmanagerportal.jsp'
  }
  function f(obj) {
      window.location='efmformmanageredit.jsp'
  }
...
<table border="0" cellpadding="0" cellspacing="5" width="98%">
    <tr>
        <td>
                    ...
                    <div id="portalDiv" class="inputDiv" style="display:none;">
                    	<center>
