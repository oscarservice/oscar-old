...
<%    
	...
	ProviderDataDao providerDao = (ProviderDataDao) SpringUtils.getBean("providerDataDao");
	ProviderData provider = providerDao.findByProviderNo(providerNo);
	if (provider.getSpecialty().equalsIgnoreCase("optometrist")) {
%>
	<br/>
<%      } %>
