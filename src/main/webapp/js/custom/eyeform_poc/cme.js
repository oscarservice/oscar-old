   ...
   jQuery(document).ready(function(){
	  ...
	  // window.resizeTo(screen.width,screen.height);
       ...
       reorderNavBarElements('appointmentHistory','msgs');
       reorderNavBarElements('examhistory','appointmentHistory');
       reorderNavBarElements('Billing','examhistory');
...
*/
       ...
       popColumn(ctx + "/oscarEncounter/displayMacro.do?hC=009999&appointment_no="+appointmentNo+"&displayAllItems=true&displayAllProp=eyeform_expandAllMacro","macro","macro", "rightNavBar", this);
