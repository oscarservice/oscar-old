...
<div style="float:left; width: 80%; padding-left:2px; text-align:left; font-size: 16px; color:<%=inverseUserColour%>; background-color:<%=userColour%>" id="encounterHeader">
