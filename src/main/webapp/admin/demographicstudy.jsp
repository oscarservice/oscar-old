...
<tr>
	...
	<td>
		<input readonly="readonly" disabled="disabled" type="button" class="smallButton" value="Add Provider" onclick="popupStart(768, 1024, '<%= request.getContextPath() %>/admin/addProvider.jsp?studyId=<%=study.getId()%>', 'providerselect')"/>
	</td>
</tr>
<%
}
