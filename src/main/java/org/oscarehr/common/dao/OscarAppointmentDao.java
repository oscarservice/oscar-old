...
public class OscarAppointmentDao extends AbstractDao<Appointment> {
	...
	public List<Integer> getAllApptNoByDemographicNo(Integer demographicNo) {
		String sql = "SELECT a.id FROM Appointment a WHERE a.demographicNo = " + demographicNo + " ORDER BY a.id";
		Query query = entityManager.createQuery(sql);
