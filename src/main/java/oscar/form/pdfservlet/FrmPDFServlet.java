...
public class FrmPDFServlet extends HttpServlet {
    ...
    throws DocumentException, java.io.IOException {
        ...
        try {
            ...
            int formId = Integer.parseInt(req.getParameter("formId")!=null?req.getParameter("formId"):"0");
            ...
            //changes made for encounter form export from scheduler
            String currentUser = "";
            if(LoggedInInfo.loggedInInfo!=null && LoggedInInfo.loggedInInfo.get()!=null 
            		&& LoggedInInfo.loggedInInfo.get().loggedInProvider!=null)
            	currentUser = LoggedInInfo.loggedInInfo.get().loggedInProvider.getFormattedName();
            else
            {
            	if(req.getParameter("provider_no")!=null)
            		currentUser = req.getParameter("provider_no");
            }
