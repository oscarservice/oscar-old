...
public class MsgNewMessageTag extends TagSupport {
    ...
    public int doStartTag() throws JspException    {
            ...
            try {
                ...
                {
                	sqlCommand = "select count(1) from messagelisttbl, "
                				+" msgDemoMap dm left join demographicSite ds on dm.demographic_no=ds.demographicId "
                				+" where provider_no = ? and status = 'new' and messageID = message "
                				+" and (ds.siteId in ("+siteStr+")) ";
                }
