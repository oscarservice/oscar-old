...
public class CategoryData {
	...
	public void populateCountsAndPatients(String loggedInUserId) throws SQLException {
		this.loggedInUserId = loggedInUserId;
		superSiteUtil = SuperSiteUtil.getInstance(loggedInUserId);
		
		populateCountsAndPatients();
	}
	...
	public int getLabCountForPatientSearch() throws SQLException {
        ...
        while(rs.next()){
        	...
        	if(!superSiteUtil.isUserAllowedToOpenPatientDtl(id+""))
        		continue;
	...
	public int getDocumentCountForPatientSearch() throws SQLException {
        ...
        while(rs.next()){
        	...
        	String demoId = rs.getInt("demographic_no")+"";
        	if(!superSiteUtil.isUserAllowedToOpenPatientDtl(demoId))
        		continue;
