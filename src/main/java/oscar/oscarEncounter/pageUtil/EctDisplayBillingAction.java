    	...
    	String appointmentNo = request.getParameter("appointment_no");
            ...
            if (billRegion.equals("ON")){
                ...
                if(appointmentNo != null && appointmentNo.length()>0) {
                    ...
                    Appointment appt = appointmentDao.find((appointmentNo!=null && !appointmentNo.equalsIgnoreCase("null") )? Integer.parseInt(appointmentNo) : 0);
                ...
                List<Object> aL = null;
                try{
                     aL   = dbObj.getBillingHist(bean.demographicNo, 10, 0, null, null);
                }catch(Exception e){
                ...
                for(int i=0; i<aL.size(); i=i+2) {
                        ...
                        String last_name= obj.getLast_name();
                      
                        String first_name = obj.getFirst_name();
                        String L = last_name.substring(0, 1).toUpperCase();
                        String F = first_name.substring(0, 1).toUpperCase();
                        ...
                        item.setURL(url);
                        item.setTitle(L+","+F+" "+itObj.getService_code()+" ("+itObj.getDx()+")");
