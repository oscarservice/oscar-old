...
public class MeasurementsDao extends HibernateDaoSupport {
	...
	public List<Measurements> getMeasurementsByAppointment2(int appointmentNo) {
		String queryStr = "From Measurements m WHERE m.appointmentNo = " + appointmentNo + " ORDER BY m.type, m.dateObserved ASC";
