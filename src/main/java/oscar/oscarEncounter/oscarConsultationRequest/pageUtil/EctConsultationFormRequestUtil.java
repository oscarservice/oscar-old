...
public class EctConsultationFormRequestUtil {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if( date == null || date.equals("") ) {
                	/* The default should be empty, not 1970-01-01:
            ...
            String sql2 = "select * from consultationRequestExt where name='specialProblem' and requestId  = " +id;
            ResultSet rs2 = DBHandler.GetSQL(sql2);
            if (rs2.next()) {
            	ocularExamination = oscar.Misc.getString(rs2,"value");
            }
            rs2.close();
        } catch (SQLException e) {
            MiscUtils.getLogger().error("Error", e);
    ...
    public String ocularExamination;
    ...
    public String letterheadClinic;
