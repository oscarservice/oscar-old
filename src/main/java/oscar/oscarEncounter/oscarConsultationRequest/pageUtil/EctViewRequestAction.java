    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse  response)	throws ServletException, IOException {
		...
		private static Calendar setAppointmentDateTime(EctConsultationFormRequestForm thisForm, ConsultationRequest consult) {
			...
			if( date1 == null || date2 == null ) {
				/*keep null value, don't need to have 1970-01-01 as default. It should be empty is no appt date/time.
	            ...
	            */
				thisForm.setAppointmentDay("");
				thisForm.setAppointmentMonth("");
				thisForm.setAppointmentYear("");
				thisForm.setAppointmentHour("");
				thisForm.setAppointmentMinute("");
				thisForm.setAppointmentPm("");
			}
			else {
				cal.setTime(date1);
				thisForm.setAppointmentDay(String.valueOf(cal.get(Calendar.DAY_OF_MONTH)));
