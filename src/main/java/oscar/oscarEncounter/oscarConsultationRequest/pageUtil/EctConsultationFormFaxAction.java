			...
			if (alist.size() > 0) {
				...
				else
				{
					if(request.getSession().getAttribute("user")!=null)
						currentUserFaxNo = getUserFax(request.getSession().getAttribute("user").toString());	
				}
				
				String defaultFaxModem = SmartFaxUtil.getDefaultFaxModem(currentUserFaxNo);
