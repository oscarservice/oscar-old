...
//	                    if( !indivo.updateBinaryFile(path+filename, doc.getIndivoIdx(), type, description, myOscarUserId) ) {
	                    if( !indivo.updateBinaryFile(EDocUtil.getDocumentPath(filename), doc.getIndivoIdx(), type, description, myOscarUserId) ) {
...
//	                    if( !indivo.sendBinaryFile(path+filename, type, description, myOscarUserId) ) {
	                    if( !indivo.sendBinaryFile(EDocUtil.getDocumentPath(filename), type, description, myOscarUserId) ) {
