  ...
  implements MessageHandler
{
  ...
  public GAMXRAYHandler() {
    this.logger.info("New GAMXRAYHANDLER instantiated");
  }
  ...
  public String parse(String serviceName, String fileName, int fileId) {
    ...
    int i = 0;
    try {
      ArrayList messages = Utilities.separateMessages(fileName, "GAMXRAY");

      for (i = 0; i < messages.size(); i++) {
        String msg = (String)messages.get(i);
        MessageUploader.routeReport(serviceName, "GAMXRAY", msg, fileId);
      }
