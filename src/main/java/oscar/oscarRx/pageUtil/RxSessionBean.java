...
public class RxSessionBean  implements java.io.Serializable {
   ...
   // private ArrayList stash=new ArrayList();
    ...
    private String optometristEyeParam = null;
    ...
    public String getOptometristEyeParam() {
    	return this.optometristEyeParam;
    }
    public void setOptometristEyeParam(String optometristSelect) {
    	this.optometristEyeParam = optometristSelect;
    }
